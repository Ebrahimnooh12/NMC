        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="register.php">
              ...
              <hr class="my-4">
              <button class="btn btn-lg btn-google btn-block text-uppercase" type="button"><i class="fab fa-google mr-2"></i> Sign up with Google</button>
              <button class="btn btn-lg btn-facebook btn-block text-uppercase" type="button"><i class="fab fa-facebook-f mr-2"></i> Sign up with Facebook</button>
            </form>
          </div>
        </div>
      </div>
