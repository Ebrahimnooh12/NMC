        ...
        <div class="card card-signin flex-row my-5">
          ...
          <h5 class="card-title text-center font-weight-bold">Receipt</h5> 
            ...
            <div class='d-flex justify-content-between ml-4 mr-3'>
                <h6>Unit Price</h6>
                <h6><?php echo number_format((float)$record['price'], 3, '.', ''); ?> BD</h6>
            </div>
            <div class='d-flex justify-content-between ml-4 mr-3'>
                <h6>VAT Tax (5 %)</h6>
                <h6><?php echo $vat?> BD</h6>
            </div>
            <hr>
            <div class='d-flex justify-content-between ml-4 mr-3 mb-5'>
                <h6>Total</h6>
                <h6><?php echo $record['total'] ?> BD</h6>
            </div>
            <hr>    
...
function print(){
    ...
    mywindow.document.write("<h5>&nbsp;&nbsp; Unite Price &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $record['price']?> BD</h5>");
    mywindow.document.write("<h5>&nbsp;&nbsp; VAT Tax (5%) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vat?> BD</h5>");
    mywindow.document.write("<hr>");
    mywindow.document.write("<h5>&nbsp;&nbsp; Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $record['total']?> BD</h5>");
    mywindow.document.write("<hr>");
