...
<script>  
  function print(){
     var income=0;
      ...
      mywindow.document.write('<html><head><title>National Motor Company - Bahrain</title></br><h3 align=\'center\'>Sales Report - <?php echo $_GET['year'].'/'.$_GET['month']?></h3><hr>');
      <?php }  else {?>
      mywindow.document.write('<html><head><title>National Motor Company - Bahrain</title></br><h3 align=\'center\'>Sales Report</h3><hr>');
      <?php }?>
      ...
      for (let index = 0; index < car.length; index++) {
          ...
          mywindow.document.write('<td align=\'center\'>'+car[index][6]+' BD</td>');
          mywindow.document.write('</tr>');
      ...
      mywindow.document.write("<h5 align='left'>Total Income: "+income+" BD</h5>");
