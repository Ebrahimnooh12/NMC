...
<script>  
  function print(){
      ...
      mywindow.document.write('<html><head><title>National Motor Company - Bahrain</title></br><h3 align=\'center\'>Test Drive Schedule - <?php echo $_GET['year'].'/'.$_GET['month']?></h3><hr>');
      <?php } else{?>
      mywindow.document.write('<html><head><title>National Motor Company - Bahrain</title></br><h3 align=\'center\'>Test Drive Schedule</h3><hr>');
      <?php }?>
